...
const teasePanelEl=document.querySelector("#tease-panel"),teaseMessageEl=document.querySelector("#tease-message-text"),teaseCopyEl=document.querySelector("#tease-copy"),teaseTimerEl=document.querySelector("#tease-timer"),hapticStateEl=document.querySelector("#haptic-state");
const ratingPanelEl=document.querySelector("#rating-panel"),ratingMessageEl=document.querySelector("#rating-message-text"),ratingCopyEl=document.querySelector("#rating-copy");
